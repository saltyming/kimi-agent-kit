...
- The installer concatenates `AGENTS.md` and every `kimi-rules/*.md` file into
  ...
  material.
- The preference files (`kimi-agent-kit--aside-prefs.md`, `kimi-agent-kit--dispatch-prefs.md`,
  `kimi-agent-kit--git-prefs.md`, `kimi-agent-kit--comment-prefs.md`) live in `$KIMI_CODE_HOME/rules/` and
